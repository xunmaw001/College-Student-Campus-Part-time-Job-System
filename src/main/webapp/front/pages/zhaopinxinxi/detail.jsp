				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('zhaopinxinxi','应聘')" @click="onAcrossTap('qiuzhixinxi')" type="button" class="layui-btn">
								应聘
							</button>
				...
				<div class="layui-row">
					<div class="layui-tab layui-tab-card">
						...
						<div class="layui-tab-content">
								...
								<div v-html="detail.gangweizhize"></div>
							</div>
