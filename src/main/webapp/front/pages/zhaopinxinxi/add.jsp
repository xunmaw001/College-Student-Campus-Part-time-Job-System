			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.gangwei" type="text" name="gangwei" id="gangwei" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.gongzidaiyu" type="text" name="gongzidaiyu" id="gongzidaiyu" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.xueliyaoqiu" type="text" name="xueliyaoqiu" id="xueliyaoqiu" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">工作地址：</label>
						<div class="layui-input-block">
							<input v-model="detail.gongzuodizhi" type="text" name="gongzuodizhi" id="gongzuodizhi" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                                                                            <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<textarea name="gangweizhize" id="gangweizhize">请输入岗位职责</textarea>
						</div>
					</div>
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
                        ...
                        return false
                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					...
                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					var gangweizhize = tinymce.get('#gangweizhize').getContent()
					data.gangweizhize = gangweizhize;
