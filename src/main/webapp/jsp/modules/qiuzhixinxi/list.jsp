...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">求职信息管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item"><span>求职信息管理</span></li>
								<li class="breadcrumb-item active"><span>求职信息列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">求职信息列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									<label>
										岗位
									</label>
									<input type="text" id="gangweiSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
									<label>
										学生号
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('gangwei')">岗位<i id="gangweiIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('gongzuodizhi')">工作地址<i id="gongzuodizhiIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('qiyehao')">企业号<i id="qiyehaoIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#gangweiSearch').val() != null && $('#gangweiSearch').val() != ''){
				searchForm.gangwei ="%" +  $('#gangweiSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("qiuzhixinxi/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				gangwei : searchForm.gangwei,	
		...
		function setDataRow(item,number){
			...
			var gongzuodizhiCell  = document.createElement('td');

						 gongzuodizhiCell.innerHTML = item.gongzuodizhi;


			row.appendChild(gongzuodizhiCell);
		...
		function shDialog(id){
			$("#shId").attr("value",id);
			http("qiuzhixinxi/info/" + id,"GET",{},(res)=>{
				if(res.code == 0){
		...
		function sh(){
			...
			httpJson("qiuzhixinxi/update","POST",data,(res)=>{
				if(res.code == 0){
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("qiuzhixinxi/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"qiuzhixinxi");
