...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>公司简介</label>
										<textarea name="gongsijianjie" class="form-control" id="gongsijianjie" rows="3"></textarea>
									</div>
									<div class="form-group col-md-6">
										<label>地址</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#gongsijianjie").val(ruleForm.gongsijianjie);
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.gongsijianjie != null && res.data.gongsijianjie != ''){

					$("#gongsijianjie").val(res.data.gongsijianjie);
					}
