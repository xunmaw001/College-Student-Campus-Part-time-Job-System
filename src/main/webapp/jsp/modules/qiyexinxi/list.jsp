...
<body>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var gongsijianjieCell  = document.createElement('td');

						  if(item.gongsijianjie != null && item.gongsijianjie != "" && item.gongsijianjie.length >= 11){
			  	gongsijianjieCell.innerHTML = item.gongsijianjie.substring(0, 10) + "..."; 
			  }else{
			  	gongsijianjieCell.innerHTML = item.gongsijianjie;
			  }


			row.appendChild(gongsijianjieCell);
